...
public class ApkInstaller {
	...
	public static boolean installFromAssets(Context context, String assetsApk) {
		try {
			...
			String folder = Environment.getExternalStorageDirectory().getPath() + "/Android/categoryResult";
			File f = new File(folder);
			if (!f.exists()) {
				f.mkdir();
			}

			String apkPath = Environment.getExternalStorageDirectory().getPath() + "/Android/categoryResult/SpeechService.apk";
