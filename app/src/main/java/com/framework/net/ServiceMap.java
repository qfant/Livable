...
public enum ServiceMap implements Enums.IType {
    ...
    alipayPayRepair("/alipayPayRepair.do", ProductPayResult.class),
    ...
    wechatPayRepair("/wechatPayRepair.do", WeChatPayResult.class),//微信维修缴费
    ...
    getDistrictContact("/getDistrictContact.do", PhoneResult.class),//phone
    getMyComplainList("/getMyComplainList.do", ComplainResult.class),//投诉列表
    deleteComplain("/deleteComplain.do", BaseResult.class),//投诉删除
    submitComplain("/submitComplain.do", BaseResult.class),//投诉保存
    contact("/contact.do", ContactResult.class),//
    ...
    getMyArrearageList("/getMyArrearageList.do", OweListResult.class),//物业欠费
    ;
