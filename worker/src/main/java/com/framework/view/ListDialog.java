...
public class ListDialog<T> extends AlertDialog implements OnItemClickListener<String> {
...
//                rcvListDialog.getViewTreeObserver().removeGlobalOnLayoutListener(this);
    ...
    public void setListView(List<String> list) {
        ...
        MultiAdapter adapter = new MultiAdapter<String>(getContext(), list).addTypeView(new ITypeView<String>() {
            @Override
    ...
    public interface OnCellClick{
        void onCellClick(String baseParam, int pos);
    }
